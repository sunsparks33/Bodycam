        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            <h2 className="text-xs font-bold font-mono tracking-widest text-slate-300 uppercase">
              PERSONAL LOG ARCHIVES
            </h2>
            <span className="text-[10px] font-mono text-slate-500 bg-slate-900/60 border border-slate-800/80 px-2.5 py-0.5 rounded">
              {clips.length} records filed
            </span>
          </div>
