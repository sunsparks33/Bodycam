  ...
  return (
    <div className="max-w-7xl mx-auto p-6 md:p-8">
      ...
      <div className="mb-6 flex flex-col md:flex-row md:items-center justify-between border-b border-blue-200 pb-6 gap-4">
        <div>
          <h1 className="text-xl font-bold font-mono tracking-wider text-[#1a365d] uppercase sm:text-2xl">
        ...
        <div className="flex flex-col bg-white border border-blue-200 rounded-lg px-4 py-2 text-xs font-mono shadow-sm">
          ...
          <div className="flex items-center justify-between gap-6 text-slate-500 mt-1">
            <span>BADGE ID:</span>
            <span className="text-blue-600 font-bold">#{session.user.badgeNumber}</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg text-[10px] font-mono text-blue-700 flex items-center justify-between shadow-sm">
          ...
          <div className="flex items-center justify-between border-b border-blue-200 pb-3">
            <h2 className="text-xs font-bold font-mono tracking-widest text-[#1a365d] uppercase flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-blue-500 animate-pulse" />
              <span>MY PERSONAL BODYCAM EVIDENCE REVIEWS</span>
            </h2>
            <span className="text-[10px] font-mono text-blue-600 bg-blue-50 border border-blue-200 px-2.5 py-0.5 rounded font-bold">
              {clips.length} personal clips recorded
            </span>
          </div>

          {clips.length === 0 ? (
            <div className="bg-white border border-blue-200 rounded-lg p-12 text-center text-slate-400 font-mono text-xs tracking-wider leading-relaxed shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {clips.map((clip) => {
                ...
                return (
                  <div
                    key={clip.id}
                    className="bg-white border border-blue-200 hover:border-blue-400 rounded-lg shadow-sm hover:shadow-md overflow-hidden flex flex-col transition-all duration-200"
                  >
                    {/* Video player box */}
                    <div className="relative w-full aspect-video bg-slate-100 border-b border-blue-100 flex items-center justify-center">
                      {streamableId ? (
                        <iframe
                        ...
                        <div className="text-red-500 font-mono text-[10px] p-4 text-center leading-relaxed">
                    ...
                    <div className="p-4 flex-1 flex flex-col justify-between gap-4">
                      <div>
                        <h3 className="text-xs font-bold text-[#1a365d] uppercase tracking-wide line-clamp-1">
                          {clip.title}
                        </h3>

                        <div className="grid grid-cols-2 gap-2 mt-3 pt-2 border-t border-blue-100 text-[9px] text-slate-500 font-mono">
                          <div>
                            <span className="text-slate-400 block uppercase text-[8px] tracking-wider mb-0.5">
                              Incident Date
                            </span>
                          ...
                          <div>
                            ...
                            <span
                              className={`block ${
                                clip.caseNumber ? "text-blue-600 font-bold" : "text-slate-400 font-normal"
                              }`}
                            >
                      ...
                      {/* Summary description */}
                      <div className="bg-blue-50/60 p-2.5 rounded border border-blue-100 flex-1">
